...
const typeDefs = gql`
  ...
  type Mutation {
    addUser(firstName: String!, lastName: String!, phone: String!, zipCode: String!, email: String!, password: String!): User
    accountReg(email: String!, emailConfirmed: Boolean!): Auth
